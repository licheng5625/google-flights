#!/usr/bin/env python3
"""Get price calendar grid (2D matrix) using Google Flights API."""
...
def calendar_grid(args):
    """Get price calendar grid."""
    try:
        ...
        params = {
            ...
            "departure_range": tuple(args.departure_range),
            "return_range": tuple(args.return_range),
            "adults": args.adults,
        ...
        # Get calendar
        calendar = get_calendar_grid(**params)
        ...
        output = {
            ...
            "query": {
                ...
                "return_range": args.return_range,
                "adults": args.adults,
                "currency": args.currency,
            },
            "entries": entries,
...
def main():
    parser = argparse.ArgumentParser(description="Get price calendar grid")
    ...
    parser.add_argument("--departure-range", nargs=2, required=True,
                        metavar=("START", "END"),
                        help="Departure date range (YYYY-MM-DD YYYY-MM-DD)")
    parser.add_argument("--return-range", nargs=2, required=True,
                        metavar=("START", "END"),
                        help="Return date range (YYYY-MM-DD YYYY-MM-DD)")
